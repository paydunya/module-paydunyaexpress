 ...
 */
namespace Paydunya\Paydunyaexpress\Controller\Payment;
use Paydunya\Paydunyaexpress\Helper\Data;
...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $orderDetails["p_cancel_url"] = $storeManager->getStore()->getBaseUrl() . "paydunyaexpress/payment/response";
        $orderDetails["p_return_url"] = $storeManager->getStore()->getBaseUrl() . "paydunyaexpress/payment/response";
        $orderDetails["p_callback_url"] = $storeManager->getStore()->getBaseUrl() . "paydunyaexpress/payment/ipn";
        ...
        if($redirect) {
            ...
            $this->_view->getLayout()->getBlock('paydunyaexpress')->setData("iframe", $iframe);
            
            $this->_view->getLayout()->getBlock('paydunyaexpress')->setName("PayDunya Payment");
